...
const Film = () => {
    ...
    const films = [
        ...
        },
        {
            ...
            "image": "asset/boruto-naruto-next-generations.png",
            "episode": "250"
        },
        {
            "id": "4",
    ...
    return (
        <div className="home">
            <header>
                <h1>Anonime</h1>
                <a className="homepage">Home</a>
                <a className="listpage">List anime</a>
                <input placeholder="Search anime or movie"></input>
            </header>
            <Container>
                 <main className="container">
                    <Explore selectedFilm={{selectedFilm}} />
                    <NewRelease onSelectFilm={handleSelectFilm} films = {films} />
                 </main>
            </Container>
